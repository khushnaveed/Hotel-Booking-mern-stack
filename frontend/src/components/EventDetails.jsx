...
function EventDetails() {
  ...
  if (!event) return <div className="p-10 text-center">{t("loadingEvents")}</div>;
  ...
  return (
    <>
      ...
      <div className="p-10 max-w-4xl mx-auto [&_img]:rounded-none">
        ...
        <p className="text-sm text-gray-500 mb-6">{t("date")}: {event.date}</p>
        <h2 className="text-lg text-gray-700 font-semibold mb-6">
          {t("price")}: <span>{currencySymbols[currency]}{event.price}</span>
        </h2>
